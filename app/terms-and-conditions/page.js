                ...
                <div className="container">
                    <div className="row mt-4 justify-content-center">
                        <div className="col-lg-8 col-md-10 col-11">
                            <p className={`${styles.content} mb-0`}>Welcome to i11Labs (&quot;us,&quot; &quot;we,&quot; or &quot;our&quot;). By accessing or using our website www.i11labs.com (the &quot;Site&quot;) and our services, you agree to comply with and be bound by the following Terms and Conditions.</p>
                            ...
                            <p className={`${styles.content} mb-0`}> The content and materials on the Site, including but not limited to text, graphics, logos, and images, are the intellectual property of i11Labs and are protected by copyright and trademark laws. You may not reproduce, distribute, or create derivative works from any content without our prior written consent.</p>

                            <p className={`${styles.subheading} mt-5 mb-0`}>Limitation of Liability</p>
                            <p className={`${styles.content} mb-0`}>To the fullest extent permitted by law, i11Labs shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from your access to or use of, or inability to access or use the Site.  </p>
