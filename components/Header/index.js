...
export default function Header() {
    ...
    return (
        <div className={`${stickyClass} ${i11labsClass} container-fluid sticky-top w-100`} id="navhover" style={{ marginTop: "-6rem" }}>
            <div className="py-3">
                <nav className="navbar navbar-expand-lg navbar-light">
                    <div className="container-fluid">
                        <Link href="/" className="mx-md-4 mx-2">
                            <Image src={Logo} className="img-fluid" alt="I11labs logo" title="i11labs" />
                        </Link>
                                ...
                                <div className="col-12 offcanvas-body ps-4 ps-md-5">
                                    <ul className="navbar-nav header">
                                        ...
                                        <li className="nav-item navunderline py-2">
                                            <Link className={`${styles.headercontent1} nav-link pt-3`} aria-current="page" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded={isDropdownOpen.built} href="#" onClick={() => toggleDropdown('built')}>
                                                What We Have Built
                                            ...
                                            <ul className={`dropdown-menu ps-3 ${isDropdownOpen.built ? 'show' : ''}`} aria-labelledby="navbarDropdown">
                                                <li data-bs-dismiss="offcanvas" aria-current="page">
                                                    <Link className={`${styles.subheadercontent1} dropdown-item ms-2 mb-2 navunderline py-3`} href="/dti-dumptruckit" rel="noreferrer" style={{ borderBottom: "1px solid #C1D1E0" }}>DTI</Link>
                                                </li>
                                                <li data-bs-dismiss="offcanvas" aria-current="page">
                                        ...
                                        <li className="nav-item navunderline py-2">
                                            <Link className={`${styles.headercontent1} nav-link pt-3`} aria-current="page" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded={isDropdownOpen.offerings} href="/how-we-serve/" onClick={() => toggleDropdown('offerings')}>
                                                Service Offerings
                        ...
                        <div className="collapse navbar-collapse justify-content-xl-end justify-content-center" id="navbarSupportedContent">
                            <ul className="navbar-nav">
                                ...
                                >
                                    <Link className={`${styles.headercontent} nav-link mx-lg-1 mx-xl-2 ${currentRoute === "/dti-dumptruckit/" || currentRoute === "/feeds-to-leads/" ? styles.active : ""}`}
                                        id="navbarDropdown"
                                        role="button"
                                    ...
                                    <ul className={`dropdown-menu ${isDropdownOpen.built ? 'show' : ''}`} aria-labelledby="navbarDropdown">
                                        <li className="centerheader">
                                            <Link className={`${styles.subheadercontent} dropdown-item py-2 mx-lg-3 mx-xl-4 ${currentRoute === "/dti-dumptruckit" ? styles.activeLink : ""}`} href="/dti-dumptruckit">DTI</Link>
                                        </li>
                                        <li className="centerheader">
                                            <Link className={`${styles.subheadercontent} dropdown-item py-2 mx-lg-3 mx-xl-4 ${currentRoute === "/feeds-to-leads" ? styles.activeLink : ""}`} href="/feeds-to-leads">FTL</Link>
                                        </li>
                                        <li className="centerheader">
                                            <Link className={`${styles.subheadercontent} dropdown-item py-2 mx-lg-3 mx-xl-4 ${currentRoute === "/" ? styles.activeLink : ""}`} href="#">KWC</Link>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                >
                                    <Link className={`${styles.headercontent} nav-link mx-lg-1 mx-xl-2 ${currentRoute === "/how-we-serve-you/" || currentRoute === "/ai-integration-development/" || currentRoute === "/application-modernization/" || currentRoute === "/custom-software-development-integration/" || currentRoute === "/meta-data-driven-applications/" || currentRoute === "/cloud-computing-infrastructure-solutions/" || currentRoute === "/technology-consultation-strategy/" ? styles.active : ""}`}
                                        id="navbarDropdown"
                                        role="button"
