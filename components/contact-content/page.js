    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const response = await fetch('https://dev.i11labs.com/i11nodeemail/api/emailService/i11contact', {
                    method: 'POST',
                    headers: {
                    ...
                    <div className="col-lg-4 col-md-5 col-12 p-5" id="bgcolorsection">
                        <div className="bgcolorposition pt-5 pt-md-0">
                            ...
                            <div className="pt-5 pt-md-3">
                                <p className={`${styles.para} mb-0`}><Link style={{ textDecoration: "none", color: "#191E23" }} href="tel: 214-783-2457" rel="noreferrer" target="_blank" >214-783-2457 </Link></p>
                                <p className={`${styles.para} mb-0`}><Link style={{ textDecoration: "none", color: "#191E23" }} href="mailto: projectdelivery@i11labs.com" rel="noreferrer" target="_blank">projectdelivery@i11labs.com</Link></p>
                            </div>
                        </div>
                    </div>
