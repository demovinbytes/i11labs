              ...
              <div className="row mb-3">
                ...
                <div className="col-lg-11 col-12 ps-lg-5 pt-lg-0 pt-5">
                  <div className="row">
                    ...
                    <div className="col-xl-2 col-lg-3 col-md-4 col-6">
                      <div className={`${style.footerheading}`}>What We Have Built</div>
                      <div className={`${style.footercontent} pt-3`}><Link href="/dti-dumptruckit" className={`${style.commonlink}`}>DTI</Link></div>
                      <div className={`${style.footercontent} pt-3`}><Link href="/feeds-to-leads" className={`${style.commonlink}`} >FTL</Link></div>
                      <div className={`${style.footercontent} pt-3`}><Link href="/" className={`${style.commonlink}`} onClick={handleClick}>KWC</Link></div>
                    </div>
                    <div className="col-xl-8 col-lg-6 col-12 pt-4 pt-lg-0">
                      <div className="row">
                      <div className={`${style.footerheading}`}>Service Offerings</div>
